app.controller('MainController', ['$scope', function($scope) {
    ...
    $scope.mapMarkers = [
        ...
        },
        {
            ...
            lat: -34.136998,
            lng: 18.327325,
            message: "The area is a popular spot for surfing, since powerful waves from the Atlantic Ocean rise up over rocky reefs formed by hard sandstones of the Table Mountain Group.",
        ...
        },
        {
            ...
            lat: -34.047104,  
            lng: 18.354142,
            message: "Big right-hand reef break of the Sentinel at Hout Bay, usually surfed by tow-in. Starts breaking at eight to ten ft.",
        ...
        },
        {
            ...
            lat: -32.312679, 
            lng: 18.330055,
            message: "It is a world class surfing location and is also noted for its caves, which have a number of rock paintings.",
        ...
        },
        {
            ...
            lat: -34.004923,  
            lng: 22.549891,
            message: "It is a popular beach for surfers, consisting of a right hand reef-like wave which rolls over small boulder-like rocks for about 200m. District and National surf competitions are often held at Vic Bay and despite its small size, Vic Bay is a well-known and much-visited spot.",
        ...
        },
        {
            ...
            lat: -34.107893,  
            lng:  18.816643,
            message: "The beachbreak at Strand gets quite good, but several outside reefs and other waves make the entire area really interesting. The Strand is usually a small-wave spot, as it doesn’t pick up that much swell.",
        ...
        },
        {
            ...
            lat: -32.995888,   
            lng:  27.951894,
            message: "Nahoon Reefhe waves break on a point and can get quite large, but the sheer power and speed derived from the waves is quite spectacular.",
        ...
        },
        {
            ...
            lat: -33.599121,   
            lng:  26.906256,
            message: "The best time of year for surfing East Pier (Port Alfred) with consistent clean waves (rideable swell with light / offshore winds) is during Winter and most often the month of June.",
